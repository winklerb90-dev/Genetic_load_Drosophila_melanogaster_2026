...
# Load data:
if (!file.exists("C:/path/coding_R/data/input/intersection_tsv_files/stacked_gerp_rates_intersection.csv")){
gerp_rates_intersection_chr_X <- vroom("C:/path/coding_R/data/input/intersection_tsv_files/gerp_rates_intersection_chr_X.tsv.gz", 
                                       delim = "\t", escape_double = FALSE,
                                       col_names = FALSE, trim_ws = TRUE)

gerp_rates_intersection_chr_2L <- vroom("C:/path/coding_R/data/input/intersection_tsv_files/gerp_rates_intersection_chr_2L.tsv.gz", 
                                             delim = "\t", escape_double = FALSE, 
                                             col_names = FALSE, trim_ws = TRUE)

gerp_rates_intersection_chr_2R <- vroom("C:/path/coding_R/data/input/intersection_tsv_files/gerp_rates_intersection_chr_2R.tsv.gz", 
                                        delim = "\t", escape_double = FALSE, 
                                        col_names = FALSE, trim_ws = TRUE)

gerp_rates_intersection_chr_3L <- vroom("C:/path/coding_R/data/input/intersection_tsv_files/gerp_rates_intersection_chr_3L.tsv.gz", 
                                        delim = "\t", escape_double = FALSE, 
                                        col_names = FALSE, trim_ws = TRUE)

gerp_rates_intersection_chr_3R <- vroom("C:/path/coding_R/data/input/intersection_tsv_files/gerp_rates_intersection_chr_3R.tsv.gz", 
                                        delim = "\t", escape_double = FALSE, 
                                        col_names = FALSE, trim_ws = TRUE)

gerp_rates_intersection_chr_4 <- vroom("C:/path/coding_R/data/input/intersection_tsv_files/gerp_rates_intersection_chr_4.tsv.gz", 
                                        delim = "\t", escape_double = FALSE, 
                                        col_names = FALSE, trim_ws = TRUE)
...
# Preliminary check on mean values:
...
# C
alculate genetic load function:
...
# Calculate gerp load for X chromosome: 
...
# Calculate gerp load data for autosomes: 
...
# The final file 'dataset_gerp_method.csv' will be used in the sections 4_statistics and 5_visualisation
